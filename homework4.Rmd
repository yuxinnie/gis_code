...
```{r warning=FALSE} 
gender_inequality <- read_csv('F:/00CASA/GIS/wk4/HDR21-22_Composite_indices_complete_time_series.csv',na = 'NA')
...
```{r}
worldmap <- st_read('F:/00CASA/GIS/wk4/World_Countries_(Generalized)/World_Countries__Generalized_.shp')
head(worldmap)
```
```{r}
